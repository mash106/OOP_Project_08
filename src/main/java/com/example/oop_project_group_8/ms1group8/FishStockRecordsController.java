...
public class FishStockRecordsController {
    ...
    @FXML
    private TableView<com.example.oop_project_group_8.ms1group8.FishStock> stockTable;

    @FXML
    private TableColumn<com.example.oop_project_group_8.ms1group8.FishStock, String> speciesColumn;

    @FXML
    private TableColumn<com.example.oop_project_group_8.ms1group8.FishStock, String> tankColumn;

    @FXML
    private TableColumn<com.example.oop_project_group_8.ms1group8.FishStock, Integer> countColumn;
    ...
    private final ObservableList<com.example.oop_project_group_8.ms1group8.FishStock> fishStockList = FXCollections.observableArrayList();
    ...
    public void initialize() {
        ...
        fishStockList.add(new com.example.oop_project_group_8.ms1group8.FishStock("Tilapia", "Tank A", 1000));
        fishStockList.add(new com.example.oop_project_group_8.ms1group8.FishStock("Ruhu", "Tank B", 800));
        fishStockList.add(new com.example.oop_project_group_8.ms1group8.FishStock("Carp", "Tank C", 600));
        fishStockList.add(new com.example.oop_project_group_8.ms1group8.FishStock("Pangasius", "Tank D", 1500));
        fishStockList.add(new com.example.oop_project_group_8.ms1group8.FishStock("Catla", "Tank E", 1100));
        fishStockList.add(new com.example.oop_project_group_8.ms1group8.FishStock("Grass Carp", "Tank F", 950));
    ...
    private void handleGenerateReport() {
        ...
        for (com.example.oop_project_group_8.ms1group8.FishStock stock : fishStockList) {
